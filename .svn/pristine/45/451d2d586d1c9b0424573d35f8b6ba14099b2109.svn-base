...
public class TableConstantPlugin extends PluginAdapter {
    ...
    public List<GeneratedJavaFile> contextGenerateAdditionalJavaFiles(final IntrospectedTable introspectedTable) {
        ...
        FullyQualifiedJavaType tableConstant = new FullyQualifiedJavaType(properties.getProperty("targetPackage") + ".T" + beanName);
        ...
        for (IntrospectedColumn introspectedColumn : introspectedColumns) {
            ...
            addFieldComment(field, "@Fields " + introspectedColumn.getActualColumnName().toUpperCase() + ": " + introspectedColumn.getRemarks());
            topLevelClass.addField(field);
        }
