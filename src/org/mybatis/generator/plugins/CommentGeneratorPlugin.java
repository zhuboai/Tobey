...
public class CommentGeneratorPlugin extends PluginAdapter {
    ...
    public boolean modelFieldGenerated(final Field field, final TopLevelClass topLevelClass, final IntrospectedColumn introspectedColumn,
            final IntrospectedTable introspectedTable, final Plugin.ModelClassType modelClassType) {
    ...
    @Override
    public boolean clientDeleteByExampleMethodGenerated(final Method method, final TopLevelClass interfaze,
    ...
    @Override
    public boolean clientInsertSelectiveMethodGenerated(final Method method, final TopLevelClass interfaze,
            final IntrospectedTable introspectedTable) {
