...
public class MybatisServicePlugin extends PluginAdapter {
     ...
     * @param files
     */
    protected void addService(final Interface interface1, final IntrospectedTable introspectedTable, final String tableName, final List<GeneratedJavaFile> files) {
        ...
        sb = new StringBuilder();
        sb.append("* @author: linyl linyuliang.85@gmail.com");
        interface1.addJavaDocLine(sb.toString());
     ...
     * @param files
     */
    protected void addServiceImpl(final TopLevelClass topLevelClass, final IntrospectedTable introspectedTable, final String tableName, final List<GeneratedJavaFile> files) {
    ...
    protected Method getOtherInteger(final String methodName, final IntrospectedTable introspectedTable, final String tableName, final int type) {
        ...
        sb.append("return this.");
        sb.append(getDaoShort());
        if (introspectedTable.hasBLOBColumns() && !"updateByPrimaryKeySelective".equals(methodName) && !"deleteByPrimaryKey".equals(methodName) && !"deleteByExample".equals(methodName)
